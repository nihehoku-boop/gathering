...
const MODERN_LIBRARY_NONFICTION: BookData[] = [
  ...
  { title: 'The Confessions', author: 'Jean-Jacques Rousseau' },
  { title: 'The Social Contract', author: 'Jean-Jacques Rousseau' },
  { title: 'Discourse on the Origin of Inequality', author: 'Jean-Jacques Rousseau' },
  { title: 'Emile', author: 'Jean-Jacques Rousseau' },
  { title: 'Reveries of the Solitary Walker', author: 'Jean-Jacques Rousseau' },
...
// The Guardian's 100 Best Nonfiction Books (Complete list)
...
const GUARDIAN_NONFICTION: BookData[] = [
  ...
  { title: 'The Second Common Reader', author: 'Virginia Woolf' },
  { title: 'Moments of Being', author: 'Virginia Woolf' },
  { title: 'The Diary of Virginia Woolf', author: 'Virginia Woolf' },
  { title: 'The Letters of Virginia Woolf', author: 'Virginia Woolf' },
  { title: 'The Essays of Virginia Woolf', author: 'Virginia Woolf' },
  ...
  { title: 'Upheaval', author: 'Jared Diamond' },
  ...
  { title: 'The Color of Law', author: 'Richard Rothstein' },
  { title: 'The New Jim Crow', author: 'Michelle Alexander' },
  { title: 'Stamped from the Beginning', author: 'Ibram X. Kendi' },
  { title: 'How to Be an Antiracist', author: 'Ibram X. Kendi' },
  { title: 'The 1619 Project', author: 'Nikole Hannah-Jones' },
  { title: 'The Half Has Never Been Told', author: 'Edward E. Baptist' },
  { title: 'The Warmth of Other Suns', author: 'Isabel Wilkerson' },
  { title: 'The Fire Next Time', author: 'James Baldwin' },
  { title: 'Notes of a Native Son', author: 'James Baldwin' },
  ...
  { title: 'The Price of the Ticket', author: 'James Baldwin' },
  { title: 'The Cross of Redemption', author: 'James Baldwin' },
  { title: 'Native Son', author: 'Richard Wright' },
  { title: 'Black Boy', author: 'Richard Wright' },
  { title: 'The Outsider', author: 'Richard Wright' },
  { title: 'The Long Dream', author: 'Richard Wright' },
  { title: 'Lawd Today', author: 'Richard Wright' },
  ...
  { title: 'American Hunger', author: 'Richard Wright' },
  { title: 'The Color Curtain', author: 'Richard Wright' },
  { title: 'Black Power', author: 'Richard Wright' },
  { title: 'White Man, Listen!', author: 'Richard Wright' },
  { title: 'Pagan Spain', author: 'Richard Wright' },
  { title: 'The God That Failed', author: 'Richard Wright' },
  { title: '12 Million Black Voices', author: 'Richard Wright' },
  { title: 'How \'Bigger\' Was Born', author: 'Richard Wright' },
  { title: 'I Tried to Be a Communist', author: 'Richard Wright' },
  { title: 'The Ethics of Living Jim Crow', author: 'Richard Wright' },
  { title: 'Blueprint for Negro Writing', author: 'Richard Wright' },
  { title: 'The Literature of the Negro in the United States', author: 'Richard Wright' },
  { title: 'Savage Holiday', author: 'Richard Wright' },
  { title: 'Rite of Passage', author: 'Richard Wright' },
  { title: 'A Father\'s Law', author: 'Richard Wright' },
  { title: 'Haiku: This Other World', author: 'Richard Wright' },
]
...
// The Telegraph's 100 Best Nonfiction Books (Complete list)
const TELEGRAPH_NONFICTION: BookData[] = [
  ...
  { title: 'The Discourses', author: 'Niccolò Machiavelli' },
  ...
  { title: 'The Theory of Moral Sentiments', author: 'Adam Smith' },
...
// The Paris Review's 100 Best Nonfiction (Complete list)
const PARIS_REVIEW_NONFICTION: BookData[] = [
  ...
  { title: 'Totem and Taboo', author: 'Sigmund Freud' },
  { title: 'Moses and Monotheism', author: 'Sigmund Freud' },
  { title: 'The Future of an Illusion', author: 'Sigmund Freud' },
  { title: 'Group Psychology and the Analysis of the Ego', author: 'Sigmund Freud' },
  { title: 'The Psychopathology of Everyday Life', author: 'Sigmund Freud' },
  { title: 'Jokes and Their Relation to the Unconscious', author: 'Sigmund Freud' },
  { title: 'Three Essays on the Theory of Sexuality', author: 'Sigmund Freud' },
  { title: 'Introductory Lectures on Psycho-Analysis', author: 'Sigmund Freud' },
  { title: 'New Introductory Lectures on Psycho-Analysis', author: 'Sigmund Freud' },
  { title: 'The Question of Lay Analysis', author: 'Sigmund Freud' },
  { title: 'The Uncanny', author: 'Sigmund Freud' },
  { title: 'The Moses of Michelangelo', author: 'Sigmund Freud' },
  { title: 'Leonardo da Vinci and a Memory of His Childhood', author: 'Sigmund Freud' },
  { title: 'Dostoevsky and Parricide', author: 'Sigmund Freud' },
  { title: 'The Economic Problem of Masochism', author: 'Sigmund Freud' },
  { title: 'The Dissolution of the Oedipus Complex', author: 'Sigmund Freud' },
  { title: 'Some Psychical Consequences of the Anatomical Distinction Between the Sexes', author: 'Sigmund Freud' },
  { title: 'Female Sexuality', author: 'Sigmund Freud' },
  { title: 'Fetishism', author: 'Sigmund Freud' },
  { title: 'Splitting of the Ego in the Process of Defence', author: 'Sigmund Freud' },
  { title: 'An Outline of Psycho-Analysis', author: 'Sigmund Freud' },
]
