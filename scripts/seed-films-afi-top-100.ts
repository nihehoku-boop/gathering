...
const AFI_TOP_100_FILMS = [
  ...
  { year: 1967, title: 'Bonnie and Clyde' },
  { year: 1979, title: 'Apocalypse Now' },
  { year: 1939, title: 'Mr. Smith Goes to Washington' },
  { year: 1948, title: 'The Treasure of the Sierra Madre' },
  { year: 1977, title: 'Annie Hall' },
  { year: 1974, title: 'The Godfather Part II' },
  { year: 1952, title: 'High Noon' },
  { year: 1962, title: 'To Kill a Mockingbird' },
  ...
  { year: 1959, title: 'North by Northwest' },
  { year: 1961, title: 'West Side Story' },
  { year: 1954, title: 'Rear Window' },
  { year: 1933, title: 'King Kong' },
  { year: 1915, title: 'The Birth of a Nation' },
  { year: 1951, title: 'A Streetcar Named Desire' },
  { year: 1971, title: 'A Clockwork Orange' },
  { year: 1976, title: 'Taxi Driver' },
  { year: 1975, title: 'Jaws' },
  { year: 1937, title: 'Snow White and the Seven Dwarfs' },
  { year: 1969, title: 'Butch Cassidy and the Sundance Kid' },
  { year: 1940, title: 'The Philadelphia Story' },
  ...
  { year: 1940, title: 'Fantasia' },
  { year: 1955, title: 'Rebel Without a Cause' },
  { year: 1981, title: 'Raiders of the Lost Ark' },
  { year: 1958, title: 'Vertigo' },
  { year: 1982, title: 'Tootsie' },
  { year: 1939, title: 'Stagecoach' },
  { year: 1977, title: 'Close Encounters of the Third Kind' },
  { year: 1991, title: 'The Silence of the Lambs' },
  { year: 1976, title: 'Network' },
  { year: 1962, title: 'The Manchurian Candidate' },
  { year: 1951, title: 'An American in Paris' },
  { year: 1953, title: 'Shane' },
  { year: 1971, title: 'The French Connection' },
  { year: 1994, title: 'Forrest Gump' },
  { year: 1959, title: 'Ben-Hur' },
  { year: 1939, title: 'Wuthering Heights' },
  { year: 1925, title: 'The Gold Rush' },
  { year: 1990, title: 'Dances with Wolves' },
  { year: 1931, title: 'City Lights' },
  { year: 1973, title: 'American Graffiti' },
  { year: 1976, title: 'Rocky' },
  { year: 1978, title: 'The Deer Hunter' },
  { year: 1969, title: 'The Wild Bunch' },
  { year: 1936, title: 'Modern Times' },
  { year: 1956, title: 'Giant' },
  { year: 1986, title: 'Platoon' },
  { year: 1996, title: 'Fargo' },
  { year: 1933, title: 'Duck Soup' },
  { year: 1935, title: 'Mutiny on the Bounty' },
  { year: 1931, title: 'Frankenstein' },
  { year: 1969, title: 'Easy Rider' },
  { year: 1970, title: 'Patton' },
  { year: 1927, title: 'The Jazz Singer' },
  ...
  { year: 1956, title: 'The Searchers' },
  { year: 1938, title: 'Bringing Up Baby' },
  { year: 1992, title: 'Unforgiven' },
  { year: 1967, title: 'Guess Who\'s Coming to Dinner' },
