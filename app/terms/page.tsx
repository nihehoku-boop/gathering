...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for Gathering collection management platform',
}
        ...
        <div className="container mx-auto px-6 py-12 max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-[#fafafa]">
            <section>
              ...
              <p className="text-[#969696] leading-relaxed">
                By accessing and using Gathering ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-[#969696] leading-relaxed">
                Gathering is a collection management platform that allows users to organize, track, and manage their personal collections. The Service includes features such as collection creation, item tracking, community sharing, and profile customization.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="text-[#969696] leading-relaxed space-y-3">
                <p>7.1. The Service and its original content, features, and functionality are owned by Gathering and are protected by international copyright, trademark, and other intellectual property laws.</p>
          ...
          <div className="mt-12 pt-8 border-t border-[#353842]">
            <p className="text-sm text-[#969696] text-center">
              By using Gathering, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
            </p>
          </div>
        </div>
      </div>
