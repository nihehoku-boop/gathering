    ...
    return (
      <>
        ...
        <div className="min-h-screen bg-[#0f1114] lg:ml-64 flex items-center justify-center">
          <div className="text-center text-[#969696]">Loading...</div>
        </div>
      </>
    )
  }
    ...
    <>
      ...
      <div className="min-h-screen bg-[#0f1114] lg:ml-64">
        <div className="container mx-auto px-6 py-12">
          <h1 className="text-5xl font-semibold text-[#fafafa] mb-3 tracking-tight animate-fade-up">
            Community Collections
          </h1>
          <p className="text-[#969696] text-lg mb-10 animate-fade-up" style={{ animationDelay: '50ms' }}>
